  ...
  <?php if(!empty($report)): ?>
      ...
      <?php echo form_open('admin/report/update/'.$error_id);?>
       ...
       <div class="control-group form-inline">
            ...
            <input class="form-control" style="width: 500px; height: 30px;" type="text" name="txt_error_text" id="txt_error_text" value="<?php echo set_value('txt_error_text', (!empty($report) ? $report[0]->error_text : '')); ?>" size="50"/>
      ...
      <div>&nbsp;</div>
       <div class="control-group form-inline">
            ...
            <input class="form-control" style="width: 500px; height: 30px;" type="text" name="txt_user_id" id="txt_user_id" value="<?php echo set_value('txt_user_id', (!empty($report) ? $report[0]->user_id : '')); ?>" size="50"/>
          <div class="help-inline">
      ...
      <div>&nbsp;</div>
       <div class="control-group form-inline">
            ...
            <input class="form-control" style="width: 500px; height: 30px;" type="text" name="txt_hadith_id" id="txt_hadith_id" value="<?php echo set_value('txt_hadith_id', (!empty($report) ? $report[0]->hadith_id : '')); ?>" size="50"/>
          <div class="help-inline">
