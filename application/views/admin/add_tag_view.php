...
<div class="col-md-9" style="margin-top: 50px;">
  ...
  <hr>
	...
	<input type="text" name="txt_title_ar" value="<?php echo set_value('txt_title_ar',''); ?>" />
	...
	<input type="text" name="txt_title_en" value="<?php echo set_value('txt_title_en',''); ?>" />
	<div class="help-inline">
	...
	<input type="text" name="txt_title_ur" value="<?php echo set_value('txt_title_ur',''); ?>" />
      <div class="help-inline">
	...
	<input type="text" name="txt_detail_ar" value="<?php echo set_value('txt_detail_ar',''); ?>"/>
	<div class="help-inline">
	...
	<input type="text" name="txt_detail_en" value="<?php echo set_value('txt_detail_en',''); ?>"/>
        <div class="help-inline">
	...
	<input type="text" name="txt_detail_ur" value="<?php echo set_value('txt_detail_ur',''); ?>"/>
	<div class="help-inline">
