  ...
  <?php if(!empty($chapter)): ?>
      <?php echo form_open('admin/chapter/update/'.$chapter_id);?>
        ...
        <div class="control-group form-inline">
            ...
            <input class="form-control" style="width: 500px; height: 30px;" type="text" name="txt_title_ar" id="txt_title_ar" value="<?php echo set_value('txt_title_ar', (!empty($chapter) ? $chapter->chapter_title_ar : '')); ?>" size="50"/>
      ...
      <div class="control-group form-inline">
            ...
            <input class="form-control" style="width: 500px; height: 30px;" type="text" name="txt_title_en" id="txt_title_en" value="<?php echo set_value('txt_title_en', (!empty($chapter) ? $chapter->chapter_title_en : '')); ?>" size="50"/>
          <div class="help-inline">
      ...
      <div class="control-group form-inline">
            ...
            <input class="form-control" style="width: 500px; height: 30px;" type="text" name="txt_title_ur" id="txt_title_ur" value="<?php echo set_value('txt_title_ur', (!empty($chapter) ? $chapter->chapter_title_ur : '')); ?>" size="50"/>
          <div class="help-inline">
      ...
      <div class="control-group form-inline">
            ...
            <input class="form-control" style="width: 500px; height: 30px;" type="text" name="txt_detail_ar" id="txt_detail_ar" value="<?php echo set_value('txt_detail_ar', (!empty($chapter) ? $chapter->chapter_detail_ar : '')); ?>" size="50"/>
          <div class="help-inline">
     ...
     <div class="control-group form-inline">
            ...
            <input class="form-control" style="width: 500px; height: 30px;" type="text" name="txt_detail_en" id="txt_detail_en" value="<?php echo set_value('txt_detail_en', (!empty($chapter) ? $chapter->chapter_detail_en : '')); ?>" size="50"/>
        <div class="help-inline">
      ...
      <div>&nbsp;</div>
       <div class="control-group form-inline">
           <label class="control-label" for="txt_detail_ur">Urdu Detail:</label>&nbsp;&nbsp;&nbsp;&nbsp;
            <input class="form-control" style="width: 500px; height: 30px;" type="text" name="txt_detail_ur" id="txt_detail_ur" value="<?php echo set_value('txt_detail_ur', (!empty($chapter) ? $chapter->chapter_detail_ur : '')); ?>" size="50"/>
          <div class="help-inline">
