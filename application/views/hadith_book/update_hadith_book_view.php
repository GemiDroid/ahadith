...
<div class="col-md-9" style="margin-top: 50px;">
  ...
  <?php if(!empty($hadith_books)): ?>
      ...
      <div class="control-group">
            ...
            <input type="text" name="hadith_book_title_ar" id="hadith_book_title_ar" value="<?php echo set_value('hadith_book_title_ar', (!empty($hadith_books) ? $hadith_books->hadith_book_title_ar : '')); ?>" size="50"/>
     ...
     <div class="control-group">
            ...
            <input type="text" name="hadith_book_title_en" id="hadith_book_title_en" value="<?php echo set_value('hadith_book_title_en', (!empty($hadith_books) ? $hadith_books->hadith_book_title_en : '')); ?>" size="50"/>
            <div class="help-inline">
      ...
      <div class="control-group">
            ...
            <input type="text" name="hadith_book_title_ur" id="hadith_book_title_ur" value="<?php echo set_value('hadith_book_title_ur', (!empty($hadith_books) ? $hadith_books->hadith_book_title_ur : '')); ?>" size="50"/>
          <div class="help-inline">
