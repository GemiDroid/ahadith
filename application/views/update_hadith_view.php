  ...
  <hr/>
      ...
      <div class="control-group form-inline">
        ...
        <textarea class="form-control" name="txt_plain_ar" id="txt_plain_ar" value="<?php echo set_value('txt_plain_ar', (!empty($hadith) ? $hadith[0]->hadith_plain_ar : '')); ?>" style="width: 500px; height: 100px;" ></textarea>
    ...
    <div class="control-group form-inline">
        ...
        <textarea class="form-control" name="txt_plain_en" id="txt_plain_en" value="<?php echo set_value('txt_plain_en', (!empty($hadith) ? $hadith[0]->hadith_plain_en : '')); ?>" style="width: 500px; height: 100px;"></textarea>
        <div class="help-inline">
    ...
    <br/>
     <div class="control-group form-inline">
        ...
        <textarea class="form-control" name="txt_plain_ur" id="txt_plain_ur" value="<?php echo set_value('txt_plain_ur', (!empty($hadith) ? $hadith[0]->hadith_plain_ur : '')); ?>" style="width: 500px; height: 100px;"></textarea>
        <div class="help-inline">
    ...
    <div class="control-group form-inline">
        ...
        <textarea class="form-control" name="txt_marked_ar" id="txt_marked_ar" value="<?php echo set_value('txt_marked_ar', (!empty($hadith) ? $hadith[0]->hadith_marked_ar : '')); ?>" style="width: 500px; height: 100px;"></textarea>
        <div class="help-inline">
  ...
  <div class="control-group form-inline">
        ...
        <textarea class="form-control" name="txt_marked_en" id="txt_marked_en" value="<?php echo set_value('txt_marked_en', (!empty($hadith) ? $hadith[0]->hadith_marked_en : '')); ?>" style="width: 500px; height: 100px;"></textarea>
        <div class="help-inline">
  ...
  <br/>
    <div class="control-group form-inline">
        ...
        <textarea class="form-control" name="txt_marked_ur" id="txt_marked_ur" value="<?php echo set_value('txt_marked_ur', (!empty($hadith) ? $hadith[0]->hadith_marked_ur : '')); ?>" style="width: 500px; height: 100px;" ></textarea>
        <div class="help-inline">
  ...
  <div class="control-group form-inline">
        ...
        <textarea class="form-control" name="txt_raw_ar" id="txt_raw_ar" value="<?php echo set_value('txt_raw_ar', (!empty($hadith) ? $hadith[0]->hadith_raw_ar : '')); ?>" style="width: 500px; height: 100px;"></textarea>
        <div class="help-inline">
