  ...
  <hr>
	...
	<textarea class="form-control" name="txt_plain_ar" value="<?php echo set_value('txt_plain_ar',''); ?>" style="width: 500px; height: 100px;" ></textarea>
	...
	<textarea class="form-control" name="txt_plain_en" value="<?php echo set_value('txt_plain_en',''); ?>" style="width: 500px; height: 100px;" ></textarea>
	<div class="help-inline">
	...
	<textarea class="form-control" name="txt_plain_ur" value="<?php echo set_value('txt_plain_ur',''); ?>" style="width: 500px; height: 100px;"></textarea>
	<div class="help-inline">
   ...
   <textarea class="form-control" name="txt_marked_ar" value="<?php echo set_value('txt_marked_ar',''); ?>" style="width: 500px; height: 100px;"></textarea>
   <div class="help-inline">
  ...
  <div class="control-group form-inline">
   ...
   <textarea class="form-control" name="txt_marked_en" value="<?php echo set_value('txt_marked_en',''); ?>" style="width: 500px; height: 100px;"></textarea>
   <div class="help-inline">
  ...
  <div class="control-group form-inline">
   ...
   <textarea class="form-control" name="txt_marked_ur" value="<?php echo set_value('txt_marked_ur',''); ?>" style="width: 500px; height: 100px;"></textarea>
   <div class="help-inline">
  ...
  <div class="control-group form-inline">
   ...
   <textarea class="form-control" name="txt_raw_ar" value="<?php echo set_value('txt_raw_ar',''); ?>" style="width: 500px; height: 100px;"></textarea>
   <div class="help-inline">
     ...
     <label for="ddl_authenticity_id">Authenticity:</label>&nbsp;&nbsp;&nbsp;&nbsp;
            ...
            <select class="form-control" style="width: 500px; height: 35px;" name="ddl_authenticity_id">
